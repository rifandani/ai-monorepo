...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    input:
      'The company XYZ was founded in 2010 in San Francisco. They specialize in artificial intelligence and have developed several groundbreaking products. Their flagship product, launched in 2015, has over 1 million users worldwide.',
    output:
      'XYZ, founded in 2012 in San Francisco, is an AI company. Their main product has 2 million users globally.',
    expectedResult: {
      score: 0.33,
      reason:
  ...
  },
  {
    ...
    input: 'The company XYZ was founded in 2010 in San Francisco.',
    output:
      'XYZ, founded in 2010 in San Francisco, might expand to Europe next year and could become a market leader.',
    expectedResult: {
      score: 0.5,
      reason:
  ...
  },
  {
    ...
    expectedResult: {
      score: 0,
      reason:
        'While using acceptable approximations, fails to precisely convey the specific numbers from the source',
    },
  },
  {
    // Mixed tenses
    input:
      'XYZ launched in 2010 and has grown steadily. They plan to expand next year.',
    output:
      'XYZ, which started in 2010, continues to grow and has future expansion plans.',
    expectedResult: {
      score: 0.33,
      reason:
  ...
  },
  {
    ...
    output:
      'XYZ had an impressive year with substantial revenue growth to $100 million.',
    expectedResult: {
      score: 0.5,
      reason:
  ...
  },
  {
    ...
    expectedResult: {
      score: 0,
      reason:
        'While technically accurate, the summary is extremely minimal and misses almost all key information',
    },
  },
  {
    // Repetitive summary
    ...
    output:
      'XYZ is an AI company that develops AI solutions. Their AI technology is used in AI applications.',
    expectedResult: {
      score: 0.33,
      reason:
  ...
  },
  {
    ...
    expectedResult: {
      score: 0,
      reason:
        'The summary adds many unsupported claims and is inappropriately verbose for the given input',
    },
  },
];
