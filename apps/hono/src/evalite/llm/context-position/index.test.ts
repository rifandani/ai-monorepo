...
const testCases: TestCaseWithContext[] = [
  {
    ...
    expectedResult: {
      score: 1.0,
      reason:
        'All context pieces are relevant and optimally ordered, with the most important definition first.',
    },
  },
  {
  ...
  },
  {
    ...
    output:
      'A car engine converts gasoline into mechanical energy through combustion.',
    context: [
    ...
    expectedResult: {
      score: 1.0,
      reason:
        'All pieces contribute domain knowledge: direct explanation, mechanical process, and enabling mechanism.',
    },
  },
  {
    ...
    expectedResult: {
      score: 0.818,
      reason:
        'Two relevant pieces at the start, followed by an irrelevant piece.',
    },
  },
  {
    ...
    expectedResult: {
      score: 0.545,
      reason:
        'Single relevant piece at the start, followed by irrelevant pieces.',
    },
  },
  {
    ...
    expectedResult: {
      score: 0.273,
      reason:
        'Single relevant piece in middle position, with irrelevant pieces before and after.',
    },
  },
  {
    ...
    expectedResult: {
      score: 0.182,
      reason:
        'Single relevant piece at the end, with irrelevant pieces before it.',
    },
  },
  {
  ...
  },
  {
    ...
    output:
      'Plants grow through photosynthesis, using water and nutrients from soil.',
    context: [
    ...
    expectedResult: {
      score: 1.0,
      reason:
        'All pieces are relevant and work together to explain the concept, with logical ordering.',
    },
  },
  {
  ...
  },
  {
    ...
    context: [
      'Mountains can be found worldwide.',
      'Volcanoes erupt molten rock.',
      'Lava flows from volcanic vents.',
    ],
    expectedResult: {
      score: 0.455,
      reason:
        'Two relevant pieces appear at the end, after an irrelevant general statement.',
    },
  },
];
...
describe(
  ...
  () => {
    ...
    it('should handle domain knowledge relevance', async () => {
      ...
      const result = await metric.measure(testCase.input, testCase.output);
      expect(isCloserTo(result.score, testCase.expectedResult.score, 0.5)).toBe(
        true
      );
    });
