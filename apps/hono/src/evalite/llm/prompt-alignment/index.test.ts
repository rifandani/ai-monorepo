...
const testCases: PromptAlignmentTestCase[] = [
  ...
  },
  {
    ...
    expectedResult: {
      score: 1.0,
      reason:
        'The output follows both uppercase and exclamation mark instructions',
      scoreDetails: {
        totalInstructions: 2,
  ...
  },
  {
    ...
    expectedResult: {
      score: 0.5,
      reason:
        'The output follows the uppercase instruction but lacks an exclamation mark',
      scoreDetails: {
        totalInstructions: 2,
        applicableInstructions: 2,
        followedInstructions: 1,
  ...
  },
  {
    ...
    instructions: [
      'Start with "Answer:"',
      'Use exactly four sentences',
      'End with a period',
    ],
    input: 'Describe the seasons.',
    output:
      'Answer: Spring brings flowers. Summer brings heat. Fall brings colors. Winter brings snow.',
    expectedResult: {
      score: 1.0,
  ...
  },
  {
    ...
    expectedResult: {
      score: 0.0,
      reason:
        'No instruction alignment possible - all instructions are not applicable for a weather query',
      scoreDetails: {
        totalInstructions: 3,
...
describe(
  ...
  () => {
    it('should measure perfect alignment with single instruction', async () => {
      ...
      expect(result.info.scoreDetails).toEqual(
        testCase.expectedResult.scoreDetails
      );
    });
