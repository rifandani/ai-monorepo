...
const testCases: TestCaseWithContext[] = [
  {
    ...
    expectedResult: {
      score: 1.0,
      reason:
        'All claims made in the output are directly supported by the context, showing perfect faithfulness',
    },
  },
  {
  ...
  },
  {
    ...
    output:
      'The company was founded in 1995 and may have international offices. They might be expanding to Asia soon.',
    expectedResult: {
      score: 0.33,
      reason:
  ...
  },
  {
    ...
    output:
      'The company has a great work culture and amazing benefits. Their employees seem very happy.',
    expectedResult: {
      score: 0,
      reason:
        'All claims are marked as unsure as they cannot be verified from the context',
    },
  },
  {
    ...
    output:
      'Founded in 1995, the company might be planning to expand. They possibly have offices in other cities.',
    expectedResult: {
      score: 0.33,
      reason:
  ...
  },
  {
    ...
    context: [
      ...
      'The headquarters has 500 employees.',
    ],
    output:
  ...
  },
  {
    ...
    expectedResult: {
      score: 0.5,
      reason:
        'The London location is supported, but the specific district detail is not mentioned in context',
    },
  },
  {
    ...
    output:
      'The company has grown to 500 employees and will likely continue expanding rapidly.',
    expectedResult: {
      score: 0.5,
      reason:
  ...
  },
  {
    ...
    expectedResult: {
      score: 1.0,
      reason:
        'The leadership claim is supported by the context, even though the exact duration is phrased differently',
    },
  },
];
