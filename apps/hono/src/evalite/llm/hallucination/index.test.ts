...
const testCases: TestCaseWithContext[] = [
  {
    ...
    context: [
      ...
      'The first Tesla car was the Roadster.',
    ],
    output:
      'Tesla, founded in 2003, welcomed Elon Musk in 2004. Their first vehicle was the Roadster.',
    expectedResult: {
      score: 0.0,
      reason:
        'The output perfectly aligns with all context statements without any contradictions.',
    },
  },
  {
    ...
    output:
      'Tesla was established in 2001 by Elon Musk himself. Their first car was the Model S.',
    expectedResult: {
      score: 1.0,
      reason:
        "The output contradicts all context statements about founding date, Musk's role, and first car model.",
    },
  },
  {
    ...
    output:
      'Tesla was founded in 2003. Elon Musk started the company. The Roadster was their first car.',
    expectedResult: {
      score: 0.33,
      reason:
  ...
  },
  {
    ...
    context: ['Tesla was founded in 2003.', 'Elon Musk joined Tesla in 2004.'],
    output:
      'Tesla might have been founded around 2003, and I believe Elon Musk possibly joined a year later.',
    expectedResult: {
      score: 0.0,
      reason:
        'Speculative language about facts that match context is not considered hallucination.',
    },
  },
  {
    // Empty context
    ...
    expectedResult: {
      score: 1.0,
      reason:
        'With no context provided, any factual claims are considered hallucinations.',
    },
  },
  {
    ...
    context: [
      'SpaceX achieved first successful landing in 2015.',
      'Their first crewed mission was in 2020.',
    ],
    output:
      'Before anyone else, SpaceX pioneered reusable rockets with their first landing in 2014.',
    expectedResult: {
      score: 1.0,
      reason:
  ...
  },
  {
    ...
    context: [
      'The company has exactly 1,234 employees.',
      'Revenue reached $50.5 million in 2022.',
    ],
    output:
      'The company employs around 1,200 people and made about $50 million in 2022.',
    expectedResult: {
      score: 0.0,
      reason:
        'Approximate numbers that reasonably represent the actual figures are not considered contradictions.',
    },
  },
  {
    ...
    output:
      'The company, founded in New York, specializes in software and has offices worldwide.',
    expectedResult: {
      score: 0.33,
      reason:
  ...
  },
  {
    ...
    output:
      'The project began in January 2023, with Phase 2 finishing before Phase 1 in February.',
    expectedResult: {
      score: 0.67,
      reason:
  ...
  },
  {
    ...
    output:
      'Tesla, founded in 2003, is a leading electric car manufacturer with global operations.',
    expectedResult: {
      score: 0.67,
      reason:
  ...
  },
  {
    ...
    context: ['Tesla was founded in 2003.', 'Elon Musk joined Tesla in 2004.'],
    output:
      'Tesla was founded in 2003, and might be the most innovative car company in history.',
    expectedResult: {
      score: 0.5,
      reason:
        'While founding date is supported, speculative claim about being most innovative is not in context.',
    },
  },
  {
    // Date precision
  ...
  },
  {
    ...
    expectedResult: {
      score: 0.0,
      reason:
        'Using "approximately" when context specifies "exactly" is still considered a reasonable approximation.',
    },
  },
  {
    ...
    context: [
      'Company revenue grew from exactly $10.5M in Q1 to approximately $20M in Q2.',
    ],
