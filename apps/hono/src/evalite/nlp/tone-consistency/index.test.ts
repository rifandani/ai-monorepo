...
describe('ToneConsistencyMetric', () => {
  ...
  describe('tone consistency (with reference)', () => {
    it('should return perfect score for identical sentiment', () => {
      const result = metric.measure(
        'I love this amazing product!',
        'This product is wonderful and fantastic!'
      );
      const metrics = result.info as {
    ...
    it('should handle opposite sentiments', () => {
      const result = metric.measure(
    ...
    it('should handle mixed sentiment comparison', () => {
      const result = metric.measure(
  ...
  describe('tone stability (single input)', () => {
    it('should handle consistent positive tone', () => {
      const result = metric.measure(
    ...
    it('should handle consistent negative tone', () => {
      const result = metric.measure(
        'This is terrible. It never works properly. The support is awful.',
        ''
      );
      const metrics = result.info as {
        avgSentiment: number;
    ...
    it('should detect inconsistent tone', () => {
      const result = metric.measure(
    ...
    it('should handle single sentence', () => {
      const result = metric.measure('This is a great product.', '');
      const metrics = result.info as {
        avgSentiment: number;
        sentimentVariance: number;
      };
    ...
    it('should handle neutral consistent tone', () => {
      const result = metric.measure(
        'The sky is blue. The grass is green. The tree is tall.',
        ''
      );
      const metrics = result.info as {
        avgSentiment: number;
